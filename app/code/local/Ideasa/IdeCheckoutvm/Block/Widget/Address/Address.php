...
class Ideasa_IdeCheckoutvm_Block_Widget_Address_Address extends Mage_Customer_Block_Widget_Name {
  ...
  public function printPostcode() {
    ...
    $input = new Ideasa_Data_Form_Tel(array('name' => $this->getFieldName('postcode'),
  ...
  public function printTelephone() {
    ...
    $input = new Ideasa_Data_Form_Tel($map);
    $input->setId($map['id']);
  ...
  public function printMobile() {
    ...
    $input = new Ideasa_Data_Form_Tel(array('name' => $this->getFieldName('mobile'),
